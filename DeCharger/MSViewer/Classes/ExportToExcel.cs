...
namespace MSViewer.Classes
{
    public class ExportToExcel
    {
        ...
        /// <returns></returns>
        static Excel.Worksheet CreateWorkSheet(List<string> Headers, List<List<string>> Columns, Excel.Worksheet WorkSheet, int[] ColumnWidths, bool createstyle = false)
        {
            ...
            for (int i = 0; i < Columns.Count; i++)
            {
                ...
                {
                    WorkSheet.Cells[i + 2, j + 1] = Columns[i][j];
                }
            }
            if (!createstyle)
            {
        ...
        /// <returns></returns>
        static Microsoft.Office.Interop.Excel.Range CreateHeaderStyleforMgrSpectra(int HeadersCount, Excel.Worksheet xlWorkSheet)
        {
            char row = new char();

            row = FindtheCurrentAlphabet(HeadersCount);
            Microsoft.Office.Interop.Excel.Range xlWorkSheet_range = xlWorkSheet.get_Range("A1", row + "1");
        ...
        /// <param name="WorkSheet"></param>
        /// <returns></returns>
        static Excel.Worksheet CreateWorkSheet(List<String> Headers, List<MSViewer.Classes.CalculateBYCZIons.BYCZIons> Columns, Excel.Worksheet WorkSheet, string currenttext)
        {
            for (int i = 0; i < Headers.Count; i++)
            {
                WorkSheet.Cells[1, i + 1] = Headers[i];
        ...
        /// <param name="xlWorkSheet"></param>
        /// <returns></returns>
        static List<Microsoft.Office.Interop.Excel.Range> CreateColumnsStyleforBandYIons(int NumberofRows, List<CalculateBYCZIons.BYCZIons> Columns, Excel.Worksheet xlWorkSheet)
        {
        ...
        /// <param name="xlWorkSheet"></param>
        /// <returns></returns>
        static Microsoft.Office.Interop.Excel.Range CreateHeaderStyle(int HeadersCount, Excel.Worksheet xlWorkSheet)
        {
            char row = new char();
        ...
        /// <param name="xlWorkSheet"></param>
        /// <returns></returns>
        static List<Microsoft.Office.Interop.Excel.Range> CreateColumnsStyle(int NumberofRows, int NumberofColumns, Excel.Worksheet xlWorkSheet, int[] ColumnWidths)
        {
            char row = new char();
