       ...
       internal static Double CalculateDataPointWidth(Double width, Double height, Chart chart)
        {
            ...
            Double minDiffValue = chart.PlotDetails.GetMinOfMinDifferencesForXValue(RenderAs.Stick, RenderAs.Column, RenderAs.StackedColumn, RenderAs.StackedColumn100, RenderAs.Stock, RenderAs.CandleStick);
