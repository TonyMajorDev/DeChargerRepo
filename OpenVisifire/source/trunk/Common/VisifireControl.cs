...
namespace Visifire.Commons
{
    ...
    public abstract class VisifireControl : VisifireElement
    {
        ...
        {   
            _editIconImage = new System.Windows.Controls.Image();
            _editIconImage.HorizontalAlignment = HorizontalAlignment.Right;
            _editIconImage.VerticalAlignment = VerticalAlignment.Center;
            _editIconImage.Margin = new Thickness(2, 0, 0, 0);
            _editIconImage.Width = _editIconImage.Height = 14;
            _editIconImage.Cursor = Cursors.Hand;

            _editIconImage.MouseMove += delegate(Object sender, MouseEventArgs e)
            {
                _toolTip.Text = "Copy to clipboard";
                _toolTip.Show();
            ...
            _editIconImage.MouseLeave += delegate(Object sender, MouseEventArgs e)
            {
                _toolTip.Text = "";
                _toolTip.Hide();
            };

            _editIconImage.MouseLeftButtonUp += delegate { Save(null, Visifire.Charts.ExportType.Jpg, true); };
            Graphics.SetImageSource(_editIconImage , "Visifire.Charts." + "edit.png");
            _editIconImage.Visibility = ToolBarEnabled ? Visibility.Visible : Visibility.Collapsed;
            _toolbarContainer.Children.Add(_editIconImage);
        }
        ...
        {   
            if (_editIconImage != null)
            {   
                _editIconImage.Visibility = Visibility.Collapsed;
                _toolTip.Hide();
            ...
            if (_editIconImage != null && ToolBarEnabled)
                _editIconImage.Visibility = Visibility.Visible;
        }
        ...
        private static void OnSaveIconEnabledPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
            ...
            if (c._editIconImage != null)
                c._editIconImage.Visibility = ((Boolean)e.NewValue) ? Visibility.Visible : Visibility.Collapsed;
        }
        ...
        private System.Windows.Controls.Image _editIconImage, _saveIconImage;
